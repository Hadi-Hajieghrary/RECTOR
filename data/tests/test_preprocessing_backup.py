...
Usage:
    ...
    python test_data_loading.py --data-dir data/processed/training_interactive
...
try:
    from waymo_loader_updated import WaymoITPDataset, build_dataloader, collate_fn
except ImportError:
    print("ERROR: Cannot import waymo_loader_updated.py")
    print("Make sure waymo_loader_updated.py is in the same directory or in PYTHONPATH")
    sys.exit(1)
...
def test_preprocessing(input_dir: str, output_dir: str, max_files: int = 2):
    ...
    try:
        from preprocess_waymo_for_itp import WaymoPreprocessor
    except ImportError:
        print("❌ Cannot import preprocess_waymo_for_itp.py")
        return False
...
def main():
    ...
    if args.data_dir:
        ...
        print("Usage:")
        print("  Test with existing data: --data-dir data/processed/training_interactive")
